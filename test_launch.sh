rm -r pls_balances/results/variable_contaminants_benchmarks_test
rm -r pls_balances/results/effect_size_regression_benchmarks_test
rm -r pls_balances/results/effect_size_benchmarks_test
rm -r pls_balances/results/variable_features_benchmarks_test
...
snakemake --cores 2 --configfile variable_contaminants.yaml
snakemake --cores 2 --configfile effect_size.yaml
snakemake --cores 2 --configfile effect_size_regression.yaml
