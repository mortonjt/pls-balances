...
# snakemake --cores 8 --configfile variable_contaminants.yaml --nolock 
# snakemake --cores 8 --configfile effect_size.yaml --nolock 
# snakemake --cores 8 --configfile effect_size_regression.yaml --nolock 
# snakemake --cores 8 --configfile variable_features.yaml --nolock 
